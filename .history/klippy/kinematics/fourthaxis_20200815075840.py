# Code for handling the kinematics of Four Axis robots
#
...
class FourthKinematics:
    def __init__(self, toolhead, config):
        ...
        for rail, axis in zip(self.rails, 'xyza'):
            rail.setup_itersolve('fourthaxis_stepper_alloc', axis)
        ...
        if config.has_section('dual_carriage'):
            ...
            dc_rail.setup_itersolve('fourthaxis_stepper_alloc', dc_axis)
...
def load_kinematics(toolhead, config):
    return FourthKinematics(toolhead, config)
