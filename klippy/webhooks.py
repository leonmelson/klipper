...
class WebRequest:
    ...
    def __init__(self, client_conn, request):
        ...
        if type(self.method) != type("") or type(self.params) != type({}):
    ...
    def get_str(self, item, default=Sentinel):
        return self.get(item, default, types=(type(""),))

    def get_int(self, item, default=Sentinel):
        return self.get(item, default, types=(type(0),))

    def get_float(self, item, default=Sentinel):
        return float(self.get(item, default, types=(type(0), type(0.))))
